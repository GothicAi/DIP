...
def validate(netG, netD, GANLoss, ReconLoss, DLoss, optG, optD, dataloader, epoch, device=cuda0, batch_n="whole"):
    ...
    for i, (imgs, masks) in enumerate(dataloader):
        ...
        traditional_inpaint = torch.reshape(traditional_inpaint, (1,3,256,256))
        ...
        recon_imgs = weight_layer*recon_imgs + (1-weight_layer)*traditional_inpaint
    ...
    for i, (imgs, masks) in enumerate(dataloader):
        ...
        for item in range(len(imgs)):
            ...
            if item:
                ...
                traditional_inpaint = res
        traditional_inpaint = torch.reshape(traditional_inpaint, (config.BATCH_SIZE,3,256,256))
        traditional_inpaint = traditional_inpaint.to(device)
